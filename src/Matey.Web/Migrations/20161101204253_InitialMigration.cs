        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    PremisesMemberId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Utilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Utilities_PremisesMembers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "PremisesMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Utilities_PremisesMembers_PremisesMemberId",
                        column: x => x.PremisesMemberId,
                        principalTable: "PremisesMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bills_Utilities_UtilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_PremisesMembers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "PremisesMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_PremisesMembers_PremisesMemberId",
                        column: x => x.PremisesMemberId,
                        principalTable: "PremisesMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PremisesMembers_BillId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_PremisesMemberId",
                table: "Transactions",
                column: "PremisesMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Utilities_ManagerId",
                table: "Utilities",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_Utilities_PremisesMemberId",
                table: "Utilities",
                column: "PremisesMemberId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PremisesMembers_Bills_BillId",
                table: "PremisesMembers",
                column: "BillId",
                principalTable: "Bills",
                principalColumn: "Id",
